...
{{--  IMC, PONTUAÇÃO-IMC e PONTUAÇÃO-TRIAGEM, --}}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('antecedentes_familiares', ['Diabetes'=>'Diabetes', 'Hipertensão'=>'Hipertensão', 'Câncer'=>'Câncer', 'Alzheimer'=>'Alzheimer'], null, ['data-placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%', 'multiple']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('antecedentes_clinicos', ['Tabagista'=>'Tabagista', 'Alcoolista'=>'Alcoolista', 'Depressão'=>'Depressão', 'Doenças Cardiovasculares'=>'Doenças Cardiovasculares', 'Infarto'=>'Infarto', 'Traumatismo Craniano'=>'Traumatismo Craniano'], null, ['data-placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%', 'multiple']) }}              
        ...
        <div class="box box-success quaisdoencas" style="z-index: 99">
            <div class='box-body' style="background-color: lightgrey;">
                ...
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('quais_doencas', ['Diabetes'=>'Diabetes', 'Hipertensão'=>'Hipertensão', 'Câncer'=>'Câncer', 'Artrite Reumatóide'=>'Artrite Reumatóide', 'Inflamações'=>'Inflamações', 'Infecções'=>'Infecções', 'Febre'=>'Febre', 'Diarréia'=>'Diarréia'], null, ['data-placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%', 'multiple']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('diminu_ingesta_alimentar', [0 =>'Diminuição grave da ingesta', 1 =>'Diminuição moderada da ingesta', 2 => 'Sem diminuição da ingesta'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('perda_peso', [0 =>'Superior a três quilos', 1 =>'Não sabe informar', 2 => 'Entre um e três quilos', 3 => 'Não houve perda de peso'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('perda_peso', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('mobilidade', 'Mobilidade') }}
            {{ Form::select('mobilidade', [0 =>'Restrito ao leito ou à cadeira de rodas', 1 =>'Deambula mas não é capaz de sair de casa', 2 => 'Normal'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('stress_doenca', [0 =>'Sim', 2 => 'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('problemas_neuropsicologicos', [0 =>'Demência ou depressão graves', 1 =>'Demência ligeira', 2 => 'Sem problemas psicológicos'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('vive_emcasa', [1 =>'Sim', 0 =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('utiliza_muito_medicamentos', [0 =>'Sim', 1 =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('lesoes_pele', [0 =>'Sim', 1 =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('lesoes_pele', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('refeicoes_dia', 'Quantas refeições faz por dia?') }}
            {{ Form::select('refeicoes_dia', [0 =>'Uma refeição', 1 =>'Duas refeições', 2 => 'Três refeições'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="box box-success" style="z-index: 99">
            <div class='box-body' style="background-color: lightgrey;">
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('uma_porcao_diaria_leite', [true =>'Sim', false =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
                ...
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('duas_porcoes_semanais_legumes', [true =>'Sim', false =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
                ...
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('carne_peixe_aves', [true =>'Sim', false =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('duas_porcoes_diarias_frutas', [1 =>'Sim', 0 =>'Não'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('liquido_doente_consome_dia', [1 =>'Mais de cinco copos', 0 =>'Menos de três copos', '0.5' => 'Três a cinco copos'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('liquido_doente_consome_dia', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('modo_alimentar', 'Modo de se alimentar') }}
            {{ Form::select('modo_alimentar', [0 =>'Não é capaz de se alimentar sozinho', 1 =>'Se alimenta sozinho, mas com dificuldade', 2 => 'Se alimenta sozinho, sem dificuldade'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('doente_sua_saude', [0 =>'Pior', '0.5' => 'Não sabe', 1 =>'Igual', 2 => 'Melhor'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('doente_sua_saude', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('pb', 'Perímetro braquial(PB) em cm') }}
            {{ Form::select('pb', [0 =>'PB < 21', '0.5' => '21 <= PB <= 22', 1 =>'PB > 22'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('pb', '<span class="help-block">:message</span>') !!}
        </div>        
        <div class="form-group has-feedback">
            {{ Form::label('pp', 'Perímetro da perna(PP) em cm') }}
            {{ Form::select('pp', [0 =>'PP < 31', 1 =>'PP >= 31'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('tempo_medio_refeicao', ['Até 30 minutos' =>'Até 30 minutos', 'Mais de 30 minutos' =>'Mais de 30 minutos'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('postura_alimentacao', ['Sentada' =>'Sentada', 'Inclinada' =>'Inclinada'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('postura_alimentacao', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('aux_liquido', 'Auxílio de líquido') }}
            {{ Form::select('aux_liquido', ['NÃO' =>'NÃO','SIM' =>'SIM'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback restricaoconsistencia">
            ...
            {{ Form::select('restricao_consistencia', ['NÃO' =>'NÃO','SIM' =>'SIM'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="box box-success qualconsistencia" style="z-index: 99">
            <div class='box-body' style="background-color: lightgrey;">
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('qual_restricao', ['Sólido' =>'Sólido','Pastoso' =>'Pastoso', 'Líquido'=>'Líquido'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('usa_mastigacao', ['SIM' =>'SIM', 'NÃO' =>'NÃO'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
            {!! $errors->first('usa_mastigacao', '<span class="help-block">:message</span>') !!}
        </div>
        <div class="form-group has-feedback">
            {{ Form::label('denticao', 'Dentição') }}
            {{ Form::select('denticao', ['Presente' =>'Presente', 'Ausente' =>'Ausente'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="form-group has-feedback protese">
            ...
            {{ Form::select('protese_dentaria', ['NÃO' =>'NÃO','SIM' =>'SIM'], null, ['class'=>'form-control select2', 'style'=>'width: 100%']) }}
        ...
        <div class="box box-success qualprotese" style="z-index: 99">
            <div class='box-body' style="background-color: lightgrey;">
                <div class="form-group has-feedback">
                    ...
                    {{ Form::select('qual_protese', ['Total Superior' =>'Total Superior','Total Inferior' =>'Total Inferior', 'Pacial Superior'=>'Pacial Superior', 'Parcial Inferior'=>'Parcial Inferior'], null, ['placeholder'=>'Selecione', 'class'=>'form-control select2', 'style'=>'width: 100%']) }}
