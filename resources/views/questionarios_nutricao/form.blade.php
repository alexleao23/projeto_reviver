{{-- Form de questionário de nutrição --}}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('antecedentes_familiares', ['Diabetes'=>'Diabetes', 'Hipertensão'=>'Hipertensão', 'Câncer'=>'Câncer', 'Alzheimer'=>'Alzheimer'], null, ['placeholder'=>'Selecione','class'=>'form-control']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('antecedentes_clinicos', ['Tabagista'=>'Tabagista', 'Alcoolista'=>'Alcoolista', 'Depressão'=>'Depressão', 'Doenças Cardiovasculares'=>'Doenças Cardiovasculares', 'Infarto'=>'Infarto', 'Traumatismo Craniano'=>'Traumatismo Craniano'], null, ['placeholder'=>'Selecione','class'=>'form-control']) }}
        ...
        <div class="form-group has-feedback">
            ...
            {{ Form::select('quais_doencas', ['Diabetes'=>'Diabetes', 'Hipertensão'=>'Hipertensão', 'Câncer'=>'Câncer', 'Artrite Reumatóide'=>'Artrite Reumatóide', 'Inflamações'=>'Inflamações', 'Infecções'=>'Infecções', 'Febre'=>'Febre', 'Diarréia'=>'Diarréia', 'Outros'=>'Outros'], null, ['placeholder'=>'Selecione','class'=>'form-control']) }}
